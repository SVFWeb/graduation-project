...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    function onSearch() {
      common_vendor.index.__f__("log", "at pages/myActivity/myActivity.vue:51", searchValue.value);
    }
    return (_ctx, _cache) => {
      return {
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-7b5135b5"]]);
